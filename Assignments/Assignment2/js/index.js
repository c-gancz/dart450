...
// FUNCTION 4: Allows the login page to eventually load the Virtual Doctor dashboard page.
  ...
  function homeDashboard(){
    ...
    setInterval(function(){
      ...
      var profileText = "?name=" + encodeURI(firstname) + " " + encodeURI(lastname) + ", " + encodeURI(age) + "&residence=" + encodeURI(residence) + "&diagnosis=" + encodeURI(diagnosis);
      ...
      location.href = link + profileText;
