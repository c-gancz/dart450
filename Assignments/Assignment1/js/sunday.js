...
function coffeeCounter(){
  ...
  var coffeeTalk = "Alright, so I guess walking will be the order of the day."
  ...
  function fastSpeed(){
    $("#counter").text(coffeeMil);
      coffeeMil++;
    $('#coffeecounter').show();
    $("#info").text('Thanks for that. Maybe Christina can relax for a minute or two now.');
...
function messageOptions(){
  ...
  var options = [
    ...
    "Yess!! Wanna walk there instead?",
    "I'm down. Ready as of now.",
    "Nah, I think I'm gunna stay in an work on this arduous assignment :(",
    "One day I'll drink so much coffee my heart will explode.",
    "Okay. I wanna do anything but homework right now lol"
  ];

  // The array that holds various text that can be generated after clicking on a random text reply option.
  var abusiveResponses = [
    "Going for a drive and walking?! Too much freedom in one day.",
    "GET SOME HOMEWORK DONE ALREADY WEAKLING",
    "How about doing homework while walking? More productive perhaps"
  ]
