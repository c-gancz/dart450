...
function coffeeCounter(){
  ...
  var coffeeTalk = "Fine, make Christina miss class and ruin her life, why don't you."
  ...
  function fastSpeed(){
    $("#counter").text(coffeeMil);
      coffeeMil++;
    $('#coffeecounter').show();
    $("#info").text('CHRISTINA WILL NEVER GET TO SCHOOL BECAUSE OF YOU!!');
...
function messageOptions(){
  ...
  var options = [
    ...
    "Not so much of a good idea... Too much work to do :(",
    "Yes!!! Can I bring the wine :D",
    "Alright but don't expect me to be all there. Super stressed :(",
    "Sure, and yes the Boyfriend can come but his mind is not all there.",
    "Ahhh... so undecided."
  ];

  // The array that holds various text that can be generated after clicking on a random text reply option.
  var abusiveResponses = [
    "Great, miss a class and have a family supper. No time for work whatsoever",
    "Walk to school. No excuses!!",
    "No family supper for you."
  ]
