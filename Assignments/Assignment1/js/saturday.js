...
function coffeeCounter(){
  ...
  var coffeeTalk = "Great. Now Christina is going to fail everything."
  ...
  function fastSpeed(){
    $("#counter").text(coffeeMil);
      coffeeMil++;
    $('#coffeecounter').show();
    $("#info").text("Alright well there goes Christina's future.");
...
function messageOptions(){
  ...
  var abusiveResponses = [
    "GO BACK DOWNSTAIRS DAMMIT",
    "Maybe another break... Just another break...",
    "Just quit school now. Do it."
  ]
