...
function coffeeCounter(){
  ...
  var coffeeTalk = "For the love of god, just keep wasting Christina's time as if it's nothing."
  ...
  function fastSpeed(){
    $("#counter").text(coffeeMil);
      coffeeMil++;
    $('#coffeecounter').show();
    $("#info").text("STOP WASTING CHRISTINA'S TIME!!!");
...
function messageOptions(){
  ...
  var options = [
    ...
    "Yes absolutely will be there",
    "Sorry, gunna stay back and try and do homework :(",
    "I would but so difficult to focus at your houseee",
    "As long as I have access to the dining room.",
    "Yes, ditching all homework tonight!!"
  ];

  // The array that holds various text that can be generated after clicking on a random text reply option.
  var abusiveResponses = [
    "NO GOING OUT TO PEOPLE'S HOUSES AND HAVING FUN",
    "You are the reason you are wasting time.",
    "Just hibernate tonight. Homework only allowed."
  ]
