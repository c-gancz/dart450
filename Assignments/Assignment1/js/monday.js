...
function coffeeCounter(){
  ...
  var coffeeTalk = "Well I guess Facebook became the only thing Christina is doing today."
  ...
  function fastSpeed(){
    $("#counter").text(coffeeMil);
      coffeeMil++;
    $('#coffeecounter').show();
    $("#info").text('GET THE HELL OFF FACEBOOK!!!');
...
function messageOptions(){
  ...
  var options = [
    ...
    "Totes. I'm ditching doing any work tonight.",
    "Alright sweet! What's for supper?",
    "Sorry girl :( drowning in hw. Raincheck?",
    "Maybe tommorrow, I have plans tonight :(",
    "Ahhhhh. Homework or cooking?! Tell me what to do."
  ];

  // The array that holds various text that can be generated after clicking on a random text reply option.
  var abusiveResponses = [
    "Good luck graduating if you keep your Facebook account.",
    "Stop procrastinating and do something with yourself.",
    "You'll never get anything you want done at this rate."
  ]
